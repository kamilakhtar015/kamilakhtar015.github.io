        ...
        <div className="grid md:grid-cols-3 gap-12 items-start">
          <div className="flex justify-center md:justify-start">
            <div className="w-48 h-48 rounded-full bg-gradient-to-br from-accent/20 to-primary/20 flex items-center justify-center">
              <div className="w-44 h-44 rounded-full bg-muted flex items-center justify-center text-6xl font-bold text-muted-foreground">
                SK
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                ...
                projects, or planning my next mountain adventure.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {skills.map((skill) => (
                  <div 
                    key={skill}
                    className="flex items-center space-x-2 p-3 bg-card rounded-lg shadow-card hover:shadow-elegant transition-smooth"
                  >
