...
export const StatisticsSection = () => {
  ...
  return (
    <section id="learning-focus" className="py-20 bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-emerald-100 text-lg">Continuous growth in technology and personal development</p>
        </div>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-emerald-100 text-sm font-semibold">{project.progress}%</span>
                </div>
                ...
                <div className="space-y-2">
                  <div className="w-full bg-white/20 rounded-full h-2">
                    <div 
                      className="bg-gradient-to-r from-white to-emerald-200 h-2 rounded-full transition-all duration-1000"
